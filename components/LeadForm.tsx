        ...
        <div className="w-full md:w-1/2 bg-black text-white p-10 md:p-14 rounded-3xl shadow-2xl relative overflow-hidden">
            ...
            {formState === 'success' ? (
              <div className="h-64 flex flex-col items-center justify-center text-center animate-fade-in-up">
                ...
                <p className="text-gray-400">입력하신 이메일로 소개서를 발송했습니다.<br/>곧 담당자가 확인 후 연락드리겠습니다.</p>
                <button 
              ...
              <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                ...
                <div>
                  <label htmlFor="name" className="block text-xs font-bold uppercase tracking-wider text-gray-500 mb-2">Contact Person</label>
                  <input 
                    type="text" 
                    id="name" 
                    required 
                ...
                <button 
                  ...
                  className="w-full bg-white text-black font-bold text-lg py-5 rounded-lg hover:bg-gray-200 transition-colors flex items-center justify-center gap-2 mt-4"
                >
